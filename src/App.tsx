...
function AboutSection() {
  return (
    ...
    >
      ...
      >
        <div style={{fontFamily:'Rubik Bubbles,cursive', fontSize:30, color:'#1f3f8f', textShadow: '2px 2px 0 #d63431', letterSpacing:'1px', marginBottom:10}}>Who's BLIMPY?</div>
        <div style={{fontFamily:'Rubik Bubbles,cursive', fontSize:22, color:'#fff', textShadow: '1px 1px 0 #d63431', letterSpacing:'0.5px', marginBottom:10}}>
